    ...
    loop {
       ...
       let mut saved_config = Arc::new(saved_config);
        ...
        if saved_config.tui_interface {
            ...
            let mut status = "TcpChat // ".to_string();
            status += OffsetDateTime::now_local().unwrap().to_string().as_str();
            status += format!(
                " auth {} keys {} history {}",
...
fn ascii() -> String {
    let arts = [
        r#"
     _____ ____ ____  ____  _     ____ _____
   /__ __Y   _Y  __\/   _\/ \ /|/  _ Y__ __\
     / \ |  / |  \/||  /  | |_||| / \| / \
     | | |  \_|  __/|  \__| | ||| |-|| | |
     \_/ \____Savvich____/\_/ \|\_/ \| \_/"#,
        r#"
     /$$$$$$$$                   /$$$$$$  /$$                   /$$
    |__  $$__/                  /$$__  $$| $$                  | $$
       | $$  /$$$$$$$  /$$$$$$ | $$  \__/| $$$$$$$   /$$$$$$  /$$$$$$
       ...
       | $$| $$      | $$  | $$| $$    $$| $$  | $$ /$$__  $$  | $$ /$$
       | $$|  $$$$$$$| $$$$$$$/|  $$$$$$/| $$  | $$|  $$$$$$$  |  $$$$/
       |__/ \_______/| $$____/  \______/ |__/  |__/ \_______/   \___/
                     | $$
                     | $$   Savvich
                     |__/                                              "#,
        r#"
        ...
        r#"
        Savvich
        ____  ___  ____   ___  _   _    __   ____
       (_  _)/ __)(  _ \ / __)( )_( )  /__\ (_  _)
         )( ( (__  )___/( (__  ) _ (  /(__)\  )(
        (__) \___)(__)   \___)(_) (_)(__)(__)(__) "#,
        r#"
        _____     ____   ____      ____   _   _      _       _____
       |_ " _| U /"___|U|  _"\ uU /"___| |'| |'| U  /"\  u  |_ " _|
         | |   \| | u  \| |_) |/\| | u  /| |_| |\ \/ _ \/     | |
        /| |\   | |/__  |  __/   | |/__ U|  _  |u / ___ \    /| |\
       u |_|U    \____| |_|       \____| |_| |_| /_/   \_\  u |_|U
       _// \\_  _// \\  ||>>_    _// \\  //   \\  \\    >>  _// \\_
      (__) (__)(__)(__)(__)__)  (__)(__)(_") ("_)(__)Savvich__) (__) "#,
        r#"
      ▗▄▄▄▖▗▞▀▘▄▄▄▄   ▗▄▄▖▐▌▗▞▀▜▌   ■
        █  ▝▚▄▖█   █ ▐▌   ▐▌▝▚▄▟▌▗▄▟▙▄▖
        █      █▄▄▄▀ ▐▌   ▐▛▀▚▖    ▐▌
      ...
      \__    ___/___ ______ \_   ___ \|  |__ _____ _/  |_
        |    |_/ ___\\____ \/    \  \/|  |  \\__  \\   __\
        |    |\  \___|  |_> >     \___|   Y  \/ __ \|  |
        |____| \Savvich  __/ \______  /___|  (____  /__|
                   \/|__|           \/     \/     \/      "#,
        r#"
        _____             ___ _           _
    ...
    let art = arts[rand::random_range(..arts.len())].to_string();
    let mut width = 0;
    for line in art.lines() {
        if width < line.chars().count() {
            width = line.chars().count();
        }
    }
    let mut finaline = String::new();
    for line in art.lines() {
        finaline += (line.to_string() + (" ".repeat(width - line.chars().count()).as_str()) + "\n")
            .as_str();
    }
    finaline
}
